...
#imported GridSearchCV for hyperparameter tuning
import numpy as np
...
classifier_grid=GridSearchCV (estimator=model, param_grid=param, cv = 3, verbose=2, n_jobs = 4) #defined classifier grid 
...
classifier_grid.fit(X_train,y_train) #trained GridSearchCV on training data
classifier_grid.best_params_  # returns best hyperparameters
