...
> **NOTE**: The [main repository is on github](https://github.com/tyronechen/genomenlp) but is also mirrored on [gitlab](https://gitlab.com/tyagilab/genomenlp). Please submit any issues to the main github repository only. This software was built and tested on linux/unix platforms only, and incompatibilities have been reported with Mac OS.
